...
login_url='https://shopee.tw/buyer/login?next=https%3A%2F%2Fshopee.tw%2F'
index_url='https://shopee.tw/'
target_url='https://shopee.tw/shop/20601737'
class Connect:
    def __init__(self):
        self.status=0
    ...
    def login(self):
        if self.login_method==0:
            ...
            if not os.path.exists('cookies.json'):
                ...
                self.get_cookies()
    def day_check(self):
        self.browser.get('https://shopee.tw/shopee-coins')
        time.sleep(3)
